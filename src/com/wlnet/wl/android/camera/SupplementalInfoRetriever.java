...
package com.wlnet.wl.android.camera;
...
public abstract class SupplementalInfoRetriever extends AsyncTask<Object,Object,Object> {
  ...
  public static void maybeInvokeRetrieval(TextView textView,
    ...
    if (result instanceof URIParsedResult) {
      taskExec.execute(new URIResultInfoRetriever(textView, (URIParsedResult) result, context));
      taskExec.execute(new TitleRetriever(textView, (URIParsedResult) result));
  }
  }
