...
public class MessageDetailAdapter extends BaseAdapter {
	...
	public MessageDetailAdapter(Context mContext, List<MessageDetailEntity> lists) {
		super();
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		if (null != entity) {
//			holder.tvFromTimeTextView.setText(entity.getMessagePubdate());
...
//			holder.tvNewTextView.setText(entity.getMessageSfnew());
			...
			.load(JFConfig.HOST_URL + entity.getmDetailImgpath()).placeholder(R.drawable.img_empty)
